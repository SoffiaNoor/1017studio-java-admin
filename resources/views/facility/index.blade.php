            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a class="btn btn-primary" href="/facility/create">
                            <i class="bi bi-plus-circle mx-1"></i>Add New Facility
                        </a>
                    </div>
                    @if (count($facility) > 0)
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    @foreach ($facility as $c)
                                    <tr>
                                        <td>
                                            {{ ($facility->currentPage() - 1) * $facility->perPage() +
                                            $loop->iteration }}
                                        </td>
                                        <td>
                                            {{$c->title}}
                                        ...
                                        <td class="text-right">
                                            ...
                                            <a href="{{ route('facility.edit', $c->id) }}"><i
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content" style="border-radius:1.3rem;border:none">
                                                        ...
                                                        <div class="modal-footer" style="border-top:none">
                                                            ...
                                                            <form action="{{ route('facility.destroy', $c->id) }}"
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-end pt-4">
                                    ...
                                    <li class="page-item">
                                        <a class="page-link" href="{{ $facility->previousPageUrl() }}" tabindex="-1"
                                            style="color:#c1510c">
                                    ...
                                    @for ($i = 1; $i <= $facility->lastPage(); $i++)
                                        <li class="page-item {{ $i == $facility->currentPage() ? 'active' : '' }}">
                                            <a class="page-link" href="{{ $facility->url($i) }}"
                                                style="color:#c1510c;{{ $i == $facility->currentPage() ? 'color:white;background-color:#c1510c;border:#c1510c' : '' }}">
                                                {{ $i }}
                                            </a>
                                        </li>
                                        @endfor
