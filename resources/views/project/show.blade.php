        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-4">
                            <h4 class="card-title">Detail Project {{$project->id}}</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        @if(session('error'))
                        ...
                        <form>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" name="title" class="form-control"
                                            placeholder="title" value="{{$project->title}}" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="grid grid-cols-6">
                                            <img id="image_display" class="object-cover"
                                                ...
                                                src="{{ asset($project->image) }}" alt="image description">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="grid grid-cols-6">
                                            <img id="image_display" class="object-cover"
                                                ...
                                                src="{{ asset($project->header_image) }}" alt="image description">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="grid grid-cols-6">
                                            <img id="image_display" class="object-cover"
                                                ...
                                                src="{{ asset($project->siteplan) }}" alt="image description">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="{{ route('project.edit', $project->id) }}" class="btn btn-primary text-white"
