            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a class="btn btn-primary" href="/project/create">
                            <i class="bi bi-plus-circle mx-1"></i>Add New Project
                        </a>
                    </div>
                    @if (count($project) > 0)
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            {{ ($project->currentPage() - 1) * $project->perPage() +
                                            $loop->iteration }}
                                        </td>
                                        <td>
                                            {{$c->title}}
                                        ...
                                        <td class="text-right">
                                            ...
                                            <a href="{{ route('project.edit', $c->id) }}"><i
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content" style="border-radius:1.3rem;border:none">
                                                        ...
                                                        <div class="modal-footer" style="border-top:none">
                                                            ...
                                                            <form action="{{ route('project.destroy', $c->id) }}"
                                ...
                                <ul class="pagination justify-content-end pt-4">
                                    ...
                                    @for ($i = 1; $i <= $project->lastPage(); $i++)
                                        <li class="page-item {{ $i == $project->currentPage() ? 'active' : '' }}">
                                            <a class="page-link" href="{{ $project->url($i) }}"
                                                style="color:#c1510c;{{ $i == $project->currentPage() ? 'color:white;background-color:#c1510c;border:#c1510c' : '' }}">
                                                {{ $i }}
                                            </a>
                                        </li>
                                        @endfor
