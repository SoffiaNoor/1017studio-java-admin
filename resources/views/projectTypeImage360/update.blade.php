                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select id="id_project_type" name="id_project_type" required
                                            ...
                                            <option value="{{ $projectTypeImage360->projectType->id }}" selected>
                                                {{$projectTypeImage360->projectType->name}} -
                                                {{$projectTypeImage360->project()->title}}
                                            </option>
                                            @foreach ($projectTypeImageAll as $tj)
                                            @if ($tj->id != $projectTypeImage360->projectType->id)
