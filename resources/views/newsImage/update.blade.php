            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form method="POST" action="{{ route('newsImage.update', $newsImage->id)}}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select id="countries" name="id_news" required
                                            ...
                                            <option value="{{ $newsImage->news->id }}" selected>
                                                {{$newsImage->news->title}}
                                            </option>
                                            @foreach ($newsImageAll as $tj)
                                            @if ($tj->id != $newsImage->news->id)
