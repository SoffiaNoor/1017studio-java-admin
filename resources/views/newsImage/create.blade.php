        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-4">
                            <h4 class="card-title">Create News Image</h4>
                        </div>
                    </div>
                    @if(session('error'))
                    ...
                    @endif
                    <div class="card-body">
                        <form method="POST" action="{{ route('newsImage.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select id="countries" name="id_news" required
                                            ...
                                            <option value="" disabled selected>Choose News Type</option>
                                            @foreach ($newsId as $tj)
