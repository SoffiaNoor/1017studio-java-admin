                ...
                <div class="card-header">
                    ...
                    <div class="card-body">
                        ...
                        <form>
                                ...
                                <div class="col-md-12 pr-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" name="name" class="form-control"
                                            placeholder="title" value="{{$user->name}}" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control mt-3" id="file_input"
                                            name="photo_profile" value="" disabled>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="{{ route('user.edit', $user->id) }}" class="btn btn-primary text-white"
                                        type="submit"><i class="bi bi-pencil mx-1"></i>Edit</a>
                                    <a href="/user" class="btn btn-info text-white"><i
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="current-password" type="password"
                                    ...
                                    name="current_password" required autocomplete="current-password" disabled>
