...
@section('breadcrumb')
    Project Type Image / Detail / {{$projectTypeImage->id}}
@endsection
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-4">
                            <h4 class="card-title">Detail Project Type Image {{$projectTypeImage->id}}</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        @if(session('error'))
                        ...
                        <form>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select id="id_project_type" name="id_project_type" disabled
                                            ...
                                            <option value="{{ $projectTypeImage->id_project_type }}" selected disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="grid grid-cols-6">
                                            <img id="image_display" class="object-cover"
                                                ...
                                                src="{{ asset($projectTypeImage->image) }}" alt="image description">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="{{ route('projectTypeImage.edit', $projectTypeImage->id) }}" class="btn btn-primary text-white"
