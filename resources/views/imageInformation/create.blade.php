        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-4">
                            <h4 class="card-title">Create Image Information</h4>
                        </div>
                    </div>
                    @if(session('error'))
                    ...
                    @endif
                    <div class="card-body">
                        <form method="POST" action="{{ route('imageInformation.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
